...
function InstallExtension(vscodeExePath: string, extensionIdOrVSIXPath: string, prerelease?: boolean): string {
	...
	// Ref: https://github.com/microsoft/vscode/issues/143540#issuecomment-1073860327
	if (prerelease ?? false) {
		extensionIdOrVSIXPath = `${extensionIdOrVSIXPath}@prerelease`
	}
